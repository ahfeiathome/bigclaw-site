...
const products = [
  ...
  {
    name: 'fatfrogmodels',
    description: 'Scale model e-commerce catalog for a hobbyist brand. Dark motorsport theme with admin panel.',
    status: 'LIVE',
  ...
  {
    name: 'iris-studio',
    description: 'E-commerce platform for independent creators and small brands. Stripe-powered storefront.',
    status: 'BUILD',
    statusColor: 'bg-blue-500/10 text-blue-500',
  ...
  {
    name: 'FairConnect',
    description: 'Mobile CRM for event vendors and market sellers — customer management, booth mode, follow-ups.',
    status: 'BUILD',
    statusColor: 'bg-blue-500/10 text-blue-500',
    pricing: 'Apple IAP',
  },
